export default function CSAResources() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      {/* Featured: CSA Quick Reference Tool */}
      <div className="bg-gradient-to-r from-brand-accent-orange to-brand-accent-blue rounded-lg p-8 mb-8 text-white">
        <div className="text-center">
          ...
          <a
            href="/csa-reference"
            className="bg-white text-brand-accent-orange px-8 py-3 rounded-lg font-semibold hover:bg-gray-100 transition inline-flex items-center space-x-2"
          >
            <span>📚</span>
      ...
      <div className="bg-brand-bg-secondary border border-brand-border rounded-lg p-8 mb-8">
        <h2 className="text-2xl font-bold text-brand-text-primary mb-4">📖 CSA B149.1-25 (8th Edition) Field Tech Guide</h2>
        <p className="text-brand-text-secondary mb-6">
          Comprehensive field technician guide to the 8th Edition of CSA B149.1-25 (February 2025). Covers key 
          changes, practical applications, and real-world scenarios with interactive checklists and code references.
        </p>
        <div className="grid md:grid-cols-2 gap-4 mb-6">
          <div className="flex items-start space-x-3">
            <span className="text-brand-accent-orange text-xl">✓</span>
            <div>
              <p className="text-brand-text-primary font-semibold">8th Edition Key Changes</p>
              <p className="text-brand-text-secondary text-sm">Major updates affecting daily field work</p>
            </div>
          </div>
          <div className="flex items-start space-x-3">
            <span className="text-brand-accent-orange text-xl">✓</span>
            <div>
              <p className="text-brand-text-primary font-semibold">Practical Applications</p>
              <p className="text-brand-text-secondary text-sm">Real-world scenarios and field examples</p>
            </div>
          </div>
          <div className="flex items-start space-x-3">
            <span className="text-brand-accent-orange text-xl">✓</span>
            <div>
              <p className="text-brand-text-primary font-semibold">Interactive Checklists</p>
              <p className="text-brand-text-secondary text-sm">Save progress and track compliance</p>
            </div>
          </div>
          <div className="flex items-start space-x-3">
            <span className="text-brand-accent-orange text-xl">✓</span>
            <div>
              <p className="text-brand-text-primary font-semibold">Code References</p>
              <p className="text-brand-text-secondary text-sm">Direct links to relevant sections</p>
            </div>
          </div>
        </div>
        <a
      ...
      <div className="space-y-12">
        {/* Official Sites */}
        <div>
          <h2 className="text-2xl font-bold text-brand-text-primary mb-6">🏛️ Official Sites</h2>
        ...
        {/* Standards */}
        <div>
          <h2 className="text-2xl font-bold text-brand-text-primary mb-6">📋 Standards</h2>
          <div className="grid md:grid-cols-2 gap-6">
        ...
        {/* Updates & Bulletins */}
        <div>
          <h2 className="text-2xl font-bold text-brand-text-primary mb-6">📢 Updates & Bulletins</h2>
          <div className="grid md:grid-cols-2 gap-6">
        ...
        {/* Community */}
        <div>
          <h2 className="text-2xl font-bold text-brand-text-primary mb-6">👥 Community</h2>
          <div className="grid md:grid-cols-2 gap-6">
        ...
        <div>
          <h2 className="text-2xl font-bold text-brand-text-primary mb-6">🎓 Training & Certification</h2>
          <div className="grid md:grid-cols-2 gap-6">
