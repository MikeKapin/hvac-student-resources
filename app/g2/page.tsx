      ...
      <div className="bg-claude-bg-secondary border border-claude-border rounded-lg p-8 mb-8">
        ...
        <div className="grid md:grid-cols-2 gap-4 mb-6">
          <div className="flex items-start space-x-3">
            ...
            <div>
              <p className="text-claude-text-primary font-semibold">713 Question Bank</p>
              <p className="text-claude-text-secondary text-sm">165-question exams with full G2 topic coverage</p>
            </div>
          </div>
          <div className="flex items-start space-x-3">
            <span className="text-claude-accent-orange text-xl">✓</span>
