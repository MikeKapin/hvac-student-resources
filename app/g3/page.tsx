  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="bg-claude-bg-secondary border border-claude-border rounded-lg p-8 mb-8">
        ...
        <p className="text-claude-text-secondary mb-6">
          Professional AI tutor powered by Anthropic Claude Sonnet 4.5 for G3 certification preparation. Get instant, detailed answers about CSA B149.1-25 codes,
        ...
        <div className="grid md:grid-cols-2 gap-4 mb-6">
          ...
          <div className="flex items-start space-x-3">
            <span className="text-claude-accent-orange text-xl">✓</span>
            <div>
              <p className="text-claude-text-primary font-semibold">Units 1-9 Coverage</p>
              <p className="text-claude-text-secondary text-sm">Safety, Tools, Gas Properties, Codes, Piping & more</p>
            </div>
          </div>
          <div className="flex items-start space-x-3">
            <span className="text-claude-accent-orange text-xl">✓</span>
            <div>
              ...
              <p className="text-claude-text-secondary text-sm">Instant CSA B149.1-25 section lookup</p>
            </div>
          </div>
          <div className="flex items-start space-x-3">
            <span className="text-claude-accent-orange text-xl">✓</span>
