  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="bg-brand-bg-secondary border border-brand-border rounded-lg p-8 mb-8">
        <h2 className="text-2xl font-bold text-brand-text-primary mb-4">📝 TSSA G3 Practice Exam Simulator</h2>
        ...
        <div className="grid md:grid-cols-2 gap-4 mb-6">
          <div className="flex items-start space-x-3">
            ...
            <div>
              <p className="text-brand-text-primary font-semibold">300+ Question Bank</p>
              <p className="text-brand-text-secondary text-sm">165-question exams with full G3 topic coverage</p>
            </div>
          </div>
          <div className="flex items-start space-x-3">
            <span className="text-brand-accent-orange text-xl">✓</span>
      ...
      <div className="bg-brand-bg-secondary border border-brand-border rounded-lg p-8 mb-8">
        ...
        <p className="text-brand-text-secondary mb-6">
          Professional AI-powered study assistant for G3 certification preparation. Get instant, detailed answers about CSA B149.1-25 codes,
          residential natural gas installations, and safety procedures. Covers Units 1-9 with real-time CSA code references and expert-level guidance for appliances up to 400,000 BTU/hr.
        </p>
        <div className="grid md:grid-cols-2 gap-4 mb-6">
          <div className="flex items-start space-x-3">
            <span className="text-brand-accent-orange text-xl">✓</span>
          ...
          <div className="flex items-start space-x-3">
            <span className="text-brand-accent-orange text-xl">✓</span>
            <div>
              <p className="text-brand-text-primary font-semibold">Units 1-9 Coverage</p>
              <p className="text-brand-text-secondary text-sm">Safety, Tools, Gas Properties, Codes, Piping & more</p>
            </div>
          </div>
          <div className="flex items-start space-x-3">
            <span className="text-brand-accent-orange text-xl">✓</span>
            <div>
              ...
              <p className="text-brand-text-secondary text-sm">Instant CSA B149.1-25 section lookup</p>
            </div>
          </div>
          <div className="flex items-start space-x-3">
            <span className="text-brand-accent-orange text-xl">✓</span>
      ...
      {/* Study Guide */}
      <div className="bg-brand-bg-secondary border border-brand-border rounded-lg p-8 mb-8">
        <h2 className="text-2xl font-bold text-brand-text-primary mb-4">📚 TSSA G3 Study Guide</h2>
        <p className="text-brand-text-secondary mb-6">
          Comprehensive study guide with detailed exam preparation strategies, study tips, and complete unit coverage for your G3 certification.
        </p>
        <a
          href="/g3-study-guide.html"
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex items-center px-6 py-3 bg-brand-accent-orange hover:bg-brand-accent-orange-hover text-white font-semibold rounded-lg transition"
        >
