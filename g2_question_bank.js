// TSSA G2 Comprehensive Question Bank - Organized by CSA Units 10-24
// Total Questions: 153

const rawQuestionBank = [

    // ========================================
    // CSA UNIT 10 - 16 Questions
    // ========================================
    {
        unit: 10,
        question: "The required pipe size for section \"B\" is:",
        options: ["2 1/2\"", "2\"", "1 1/2\"", "1\""],
        correct: 0,
        reasoning: "For a 5 psig system with 2.5 psig pressure drop, section B carries 1,800,000 Btuh total (75,000 + 225,000 + 1,500,000). Using CSA B149.1 Annex C Schedule 40 pipe sizing tables at 5 psig, a 2 1/2\" pipe is required for this capacity and length.",
        csaReference: "CSA B149.1-25, Annex C - Pipe sizing tables for 5 psig systems"
    },
    {
        unit: 10,
        question: "The required pipe size for section \"C\" is:",
        options: ["3\"", "1 1/2\"", "1 1/4\"", "1\""],
        correct: 1,
        reasoning: "Section C carries 300,000 Btuh (75,000 + 225,000). Using CSA B149.1 Annex C Schedule 40 pipe sizing tables at 5 psig with 2.5 psig drop, a 1 1/2\" pipe is required.",
        csaReference: "CSA B149.1-25, Annex C - Pipe sizing tables for 5 psig systems"
    },
    {
        unit: 10,
        question: "The required pipe size for section \"D\" is:",
        options: ["3/4\"", "1 1/2\"", "2\"", "3\""],
        correct: 1,
        reasoning: "Section D supplies the 1,500,000 Btuh boiler. Using CSA B149.1 Annex C Schedule 40 pipe sizing tables at 5 psig, a 1 1/2\" pipe is required for this capacity.",
        csaReference: "CSA B149.1-25, Annex C - Pipe sizing tables for 5 psig systems"
    },
    {
        unit: 10,
        question: "The required pipe size for section \"E\" is:",
        options: ["1/2\"", "3/4\"", "1\"", "1 1/4\""],
        correct: 2,
        reasoning: "Section E supplies the 225,000 Btuh unit heater. Using CSA B149.1 Annex C Schedule 40 pipe sizing tables at 5 psig, a 1\" pipe is required.",
        csaReference: "CSA B149.1-25, Annex C - Pipe sizing tables for 5 psig systems"
    },
    {
        unit: 10,
    ...
    {
        unit: 10,
        question: "The required pipe size for section \"I\" is:",
        options: ["1 1/2\"", "1 1/4\"", "1\"", "3/4\""],
        correct: 3,
        reasoning: "Section I supplies the 75,000 Btuh furnace. Using standard pipe sizing tables, a 3/4\" pipe is adequate for this load.",
        csaReference: "CSA B149.1-25, Annex C - Natural gas pipe sizing"
    },
    {
        unit: 10,
        question: "The required pipe size for section \"J\" is:",
        options: ["1 1/2\"", "1 1/4\"", "2 1/2\"", "2\""],
        correct: 3,
        reasoning: "Section J carries combined load for multiple appliances. Based on total BTU and length, a 2\" pipe is required.",
        csaReference: "CSA B149.1-25, Annex C - Natural gas pipe sizing"
    },
    {
        unit: 10,
        question: "The required pipe size for section \"K\" is:",
        options: ["1 1/4\"", "1 1/2\"", "2\"", "2 1/2\""],
        correct: 2,
        reasoning: "Section K supplies the boilers. For 1,500,000 Btuh each, a 2\" pipe is required.",
        csaReference: "CSA B149.1-25, Annex C - Natural gas pipe sizing"
    },
    {
        unit: 10,
        question: "The required pipe size for section \"L\" is:",
        options: ["1/2\"", "1 1/4\"", "1\"", "3/4\""],
        correct: 0,
        reasoning: "Section L supplies the 50,000 Btuh stove. A 1/2\" pipe is adequate for this small load.",
        csaReference: "CSA B149.1-25, Annex C - Natural gas pipe sizing"
    },
    {
        unit: 10,
        question: "The required pipe size for section \"M\" is:",
        options: ["1\"", "1 1/4\"", "1 1/2\"", "2\""],
        correct: 1,
        reasoning: "Section M carries intermediate load. Based on BTU requirements and length, 1 1/4\" pipe is required.",
        csaReference: "CSA B149.1-25, Annex C - Natural gas pipe sizing"
    },
    {
        unit: 10,
        question: "The required pipe size for section \"N\" is:",
        options: ["1 1/4\"", "1\"", "3/4\"", "1/2\""],
        correct: 2,
        reasoning: "Section N supplies branch appliances. A 3/4\" pipe is adequate for the load carried.",
        csaReference: "CSA B149.1-25, Annex C - Natural gas pipe sizing"
    },
    {
        unit: 10,
