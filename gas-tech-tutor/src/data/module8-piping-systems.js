// CSA Unit 8 - Introduction to Piping and Tubing Systems Module Data
export const module8PipingSystemsData = {
  moduleId: 8,
  title: "Introduction to Piping and Tubing Systems",
  description: "Fundamentals of gas piping and tubing systems",
  folderPath: "Module 8 Intro to Piping and Tubing Systems",
  
  chapters: {
    1: {
      id: 1,
      title: "Piping Materials and Standards - Chapter 1",
      pdfFile: "CSA Unit 8 Chapter 1.pdf",
      content: {
        ...
        materialSelection: [
          ...
          "Pressure requirements and system design",
    ...
    2: {
      ...
      pdfFile: "CSA Unit 8 Chapter 2.pdf",
      content: {
        ...
        sizingFactors: [
          "Pipe length and equivalent fittings",
          "Number and type of fittings",
          "Elevation changes and vertical runs",
          "Gas specific gravity and heating value",
          "Operating pressure and temperature"
        ],
        practicalConsiderations: [
          "Minimum pipe sizes per code",
          "Upsizing for future appliances",
    ...
    3: {
      ...
      pdfFile: "CSA Unit 8 Chapter 3.pdf",
      content: {
        ...
        tubingTechniques: [
          ...
          "Bending techniques and radius limits",
          "Flare and compression fittings",
          "Proper tube support methods",
          "Protection from damage"
        ],
        installationStandards: [
          "Slope requirements for drainage",
          "Clearances from electrical and other utilities",
          "Protection through walls and floors",
    ...
    4: {
      ...
      pdfFile: "CSA Unit 8 Chapter 4.pdf",
      content: {
        ...
        specialtyFittings: [
          "Reducing fittings for size changes",
          "Flexible connectors for appliances",
          "Shut-off valves and controls",
          "Test connections and plugs",
          "Seismic and expansion fittings"
        ],
        jointTesting: [
    ...
    5: {
      ...
      pdfFile: "CSA Unit 8 Chapter 5.pdf",
      content: {
    ...
    6: {
      ...
      pdfFile: "CSA Unit 8 Chapter 6.pdf",
      content: {
        ...
        commissioningSteps: [
          "System walkthrough and inspection",
          "Operational testing of components",
          "Safety device function verification",
          "System performance validation",
          "Owner training and documentation"
        ],
        troubleshootingCommon: [
          "Pressure loss in system",
          "Inadequate gas flow to appliances",
          "Regulator problems and adjustment",
          "Joint leaks and repairs",
          "System contamination issues"
        ]
      }
    }
  },
  ...
  commonQuestions: [
    ...
    },
    {
      ...
      answer: "CSST has specific installation requirements: it needs bonding for electrical safety, protection from damage, proper fittings, and cannot be used in certain locations like concealed spaces in some jurisdictions. Always check local codes."
    },
    {
      question: "What's the minimum pipe size allowed for gas systems?",
      answer: "CSA B149.1 typically requires minimum 1/2\" pipe for most installations, but individual appliances may have smaller connection sizes. The system must be sized to deliver adequate gas flow at proper pressure to all appliances."
    }
  ],
  
  sizingExamples: [
    {
      title: "Residential Gas Line Sizing",
      scenario: "Size main line for house with furnace (80,000 BTU) and water heater (40,000 BTU)",
      calculation: [
        "Total load: 80,000 + 40,000 = 120,000 BTU/hr",
        "Convert to ft³/hr: 120,000 ÷ 1000 = 120 ft³/hr",
        "Measure longest run including equivalent fittings",
        "Use sizing table for calculated flow and length",
        "Select pipe size that meets requirements"
      ],
      result: "Typically requires 3/4\" to 1\" main line depending on length"
    }
  ],
  ...
  materialComparison: [
    ...
    },
    {
      ...
      advantages: ["Corrosion resistant", "Easy to bend", "Good heat transfer"],
      disadvantages: ["More expensive", "Soft metal", "Special fittings"],
      applications: ["Indoor installations", "Appliance connections"]
    },
    {
      material: "CSST",
  ...
  installationTips: [
    "Always cut pipe square and remove burrs",
    "Use proper pipe thread compound on male threads only",
    "Support pipe properly to prevent sagging",
    "Protect underground piping from corrosion",
    "Test all joints before covering or concealing",
    "Label all shut-off valves clearly",
    "Maintain proper clearances from electrical systems",
    "Document system layout for future reference"
  ],
  
  safetyReminders: [
    "Never use gas piping as electrical ground",
    "Protect piping from physical damage",
    "Ensure proper bonding of CSST systems",
    "Use only approved materials and methods",
    "Test system thoroughly before gas introduction",
    "Follow proper purging procedures",
    "Maintain adequate clearances from heat sources"
  ],
  
  keywords: [
    "piping", "tubing", "black iron", "copper", "CSST", "pipe sizing",
    "pressure drop", "equivalent length", "threading", "fittings", "joints",
    "installation", "testing", "leak detection", "materials", "NPT threads",
    "compression fittings", "flare connections", "pipe supports"
  ]
};